...
class Wallet:
    ...
    def initiate_transfer_lock(self,
        ...
        if token_name == "aergo":
            ...
            token_origin = self._config_data[origin_chain]['tokens'][token_name]['addr']
    ...
    def finalize_transfer_mint(self,
        ...
        if token_name == "aergo":
            token_origin = token_name
            # TODO store "aergo" in config file
        else:
            token_origin = self._config_data[origin_chain]['tokens'][token_name]['addr']
        ...
        self._config_data[origin_chain]['tokens'][token_name]['pegs'][destination_chain] = token_pegged
    ...
    def initiate_transfer_burn(self,
        ...
        print("  > Sender Address: ", sender)
        bridge_addr = self._config_data[origin_chain]['bridges'][destination_chain]
        token_pegged = self._config_data[destination_chain]['tokens'][token_name]['pegs'][origin_chain]
    ...
    def finalize_transfer_unlock(self,
        ...
        if token_name == "aergo":
            ...
            token_origin = self._config_data[destination_chain]['tokens'][token_name]['addr']
            origin_balance = aergo1.query_sc_state(token_origin,
                                                   ["_sv_Balances-" +
                                                    receiver,
                                                    ])
