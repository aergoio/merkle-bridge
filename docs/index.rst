...
The Aergo Merkle Bridge enables descentralized locking and efficient minting of assets.
...
The state root is recorted only if it has be signed by 2/3 of validators.
